...
public final class Checks {
    ...
    private void checkUnknownFields(RoundEnvironment roundEnv) {
        var properties = roundEnv.getElementsAnnotatedWith(ProtobufMessage.UnknownFields.class);
    ...
    private void checkMessageProperties(RoundEnvironment roundEnv) {
        var properties = roundEnv.getElementsAnnotatedWith(ProtobufMessage.Property.class);
        for (var property : properties) {
    ...
    private void processMessageProperty(Element property) {
        ...
        var annotation = property.getAnnotation(ProtobufMessage.Property.class);
    ...
    public boolean isValidPackedProperty(Element variableElement, ProtobufMessage.Property propertyAnnotation) {
