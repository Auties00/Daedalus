...
@SupportedAnnotationTypes({
        "it.auties.protobuf.annotation.ProtobufMessage.ProtobufProperty",
...
public class ProtobufJavacPlugin extends AbstractProcessor {
    ...
    public synchronized void init(ProcessingEnvironment wrapperProcessingEnv) {
        ...
        this.outputStreamType = types.getType(ProtobufBinaryWriter.class);
    ...
    private Set<ProtobufObjectElement> processObjectField(ProtobufObjectElement messageElement, VariableElement variableElement) {
        var propertyAnnotation = variableElement.getAnnotation(ProtobufMessage.Property.class);
    ...
    private Set<ProtobufObjectElement> processMessageProperty(ProtobufObjectElement messageElement, VariableElement variableElement, ProtobufMessage.Property propertyAnnotation) {
    ...
    private Optional<? extends ProtobufPropertyType> getPropertyType(Element invoker, TypeMirror elementType, TypeMirror accessorType, ProtobufMessage.Property property) {
    ...
    private Optional<? extends ProtobufPropertyType> getConcreteCollectionType(Element invoker, ProtobufMessage.Property property, TypeMirror elementType, List<TypeElement> mixins) {
    ...
    private Optional<? extends Element> getAccessor(VariableElement fieldElement, ProtobufMessage.Property propertyAnnotation) {
    ...
    private boolean isProtobufGetter(ExecutableElement entry, ProtobufMessage.Property propertyAnnotation) {
    ...
    private Optional<ProtobufPropertyType.MapType> getConcreteMapType(ProtobufMessage.Property property, Element invoker, TypeMirror elementType, List<TypeElement> mixins) {
