...
public record ProtobufInteger(BigInteger value) implements ProtobufNumber {
    private static final BigInteger MIN_PROPERTY_INDEX = BigInteger.valueOf(ProtobufMessage.MIN_PROPERTY_INDEX);
    private static final BigInteger MAX_PROPERTY_INDEX = BigInteger.valueOf(ProtobufMessage.MAX_PROPERTY_INDEX);

    private static final BigInteger MIN_ENUM_CONSTANT_INDEX = BigInteger.valueOf(ProtobufEnum.MIN_CONSTANT_INDEX);
    private static final BigInteger MAX_ENUM_CONSTANT_INDEX = BigInteger.valueOf(ProtobufEnum.MAX_CONSTANT_INDEX);
