...
public final class MessageGenerator {
    ...
    private void generateClass(CompilationUnit cu, ProtobufMessageStatement message,
        ...
        cu.addImport("it.auties.protobuf.annotation.ProtobufAccessor");
    }
    ...
    private void addImports(CompilationUnit cu, List<ProtobufFieldStatement> fields) {
        cu.addImport("it.auties.protobuf.annotation.ProtobufMessage");
        cu.addImport("it.auties.protobuf.annotation.ProtobufMessage.ProtobufProperty");
        cu.addImport("it.auties.protobuf.model.ProtobufType");
