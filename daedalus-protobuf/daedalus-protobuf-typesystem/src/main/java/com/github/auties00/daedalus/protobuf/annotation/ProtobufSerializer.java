 ...
 *     @ProtobufSerializer
 *     public String toBase64(ProtobufOptimizationProfile profile) {
 *         return Base64.getEncoder().encodeToString(data);
 *     }
 * }
 * }</pre>
 * <h2>Low-Level Serialization:</h2>
 * <p>For advanced use cases, you can serialize directly to a {@link ProtobufBinaryWriter} or {@link com.github.auties00.daedalus.protobuf.io.writer.ProtobufTextWriter}.
