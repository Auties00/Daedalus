 ...
 *     @ProtobufSize
 *     public int payloadSize(ProtobufOptimizationProfile profile) {
 *         var encodedLength = 4 * ((data.length + 2) / 3);
 *         return ProtobufSizeCalculator.getStringSize(encodedLength);
 *     }
 * }
 * }</pre>
