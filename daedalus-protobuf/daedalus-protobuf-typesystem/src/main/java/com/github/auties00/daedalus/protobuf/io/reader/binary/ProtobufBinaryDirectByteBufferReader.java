...
public final class ProtobufBinaryDirectByteBufferReader extends ProtobufBinaryReader {
    private final ByteBuffer buffer;

    public ProtobufBinaryDirectByteBufferReader(ByteBuffer buffer) {
    ...
    public ProtobufIODataType rawDataTypePreference() {
        return ProtobufIODataType.BYTE_BUFFER;
    }
    ...
    @Override
    public ProtobufBinaryDirectByteBufferReader readRawLengthDelimited(long size) {
        int bufferSize;
        try {
        ...
        try {
            var position = buffer.position();
            var result = new ProtobufBinaryDirectByteBufferReader(buffer.slice(position, bufferSize));
