...
public final class Duration {
     ...
     * {@code seconds} field and a positive or negative {@code nanos} field. For durations
     * of one second or more, a non-zero value for the {@code nanos} field must be
     * of the same sign as the {@code seconds} field. Must be from -999,999,999
